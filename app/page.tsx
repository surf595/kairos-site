    ...
    <div className="min-h-screen bg-[#f6f2ea] text-[#2f3331]">
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-16 px-6 py-12 md:gap-24 md:px-10 md:py-20">
        ...
        <section className="space-y-8" aria-labelledby="focus-areas-title">
          <h2 id="focus-areas-title" className="text-3xl leading-tight font-medium md:text-4xl">С чем я работаю</h2>
        ...
        <section id="format" className="space-y-8 rounded-[2rem] border border-[#2f3331]/15 bg-[#f8f4ed]/75 p-8 md:p-10">
          ...
          <ul className="grid gap-4 text-lg text-[#424942] md:grid-cols-2">
            ...
            <li className="rounded-2xl border border-[#2f3331]/10 bg-[#f6f2ea] p-5">
              Регулярные встречи и устойчивая рамка
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-8" aria-labelledby="faq-title">
          <h2 id="faq-title" className="text-3xl leading-tight font-medium md:text-4xl">FAQ</h2>
          <div className="space-y-4">
            {faqItems.map((item) => (
              ...
              >
                <summary className="cursor-pointer list-none pr-8 text-lg font-medium text-[#2f3331]">
                  {item.question}
                </summary>
        ...
        <footer id="contacts" className="rounded-[2rem] border border-[#2f3331]/15 bg-[#2f3331] p-8 text-[#f6f2ea] md:p-12">
          <div className="max-w-3xl space-y-5">
            <h2 className="text-3xl leading-tight font-medium md:text-4xl">Если вы чувствуете, что время пришло — можно начать с первого шага.</h2>
            <p className="text-lg text-[#ece7de]">Для записи на первичную консультацию выберите удобный способ связи.</p>
            <div className="flex flex-col gap-3 pt-2 sm:flex-row">
              <a
                href="mailto:hello@kairos-therapy.ee"
              ...
              <a
                href="https://t.me/kairos_therapy"
                className="rounded-full border border-[#f6f2ea]/60 px-6 py-3 text-center text-sm font-medium transition hover:bg-[#f6f2ea] hover:text-[#2f3331]"
              >
                Telegram
              </a>
