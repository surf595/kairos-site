        ...
        <div className="space-y-12">
          ...
          <Section title="1. Оператор персональных данных">
            <p>
              ...
              Регистрационный номер: 17338080<br/>
              Адрес: Tatari 56, кабинет 308, Tallinn, Estonia<br/>
              Email: info@kairos.ee<br/>
              Телефон: +372 509 3008
            </p>
          </Section>

          <Section title="2. Какие данные мы можем собирать">
            <ul className="list-disc pl-6 space-y-2">
              <li>имя</li>
              <li>номер телефона</li>
              <li>адрес электронной почты</li>
              <li>сообщение, отправленное через форму сайта</li>
              <li>информация о записи на консультацию</li>
              <li>технические данные посещения сайта (IP, браузер, устройство)</li>
            </ul>
          </Section>

          <Section title="3. Как мы получаем данные">
            <ul className="list-disc pl-6 space-y-2">
              <li>через форму обратной связи</li>
              <li>по электронной почте</li>
              <li>по телефону</li>
              <li>при записи на консультацию</li>
            </ul>
          </Section>

          <Section title="4. Цели обработки данных">
            <ul className="list-disc pl-6 space-y-2">
              <li>ответ на запросы пользователей</li>
              <li>организация консультаций</li>
              <li>административное управление записью</li>
          ...
          <Section title="5. Правовые основания обработки">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>подготовки или исполнения договора</li>
              <li>законных обязательств</li>
              <li>законного интереса оператора</li>
            </ul>
          </Section>

          <Section title="6. Хранение данных">
            <p>
              Персональные данные хранятся только в течение срока,
              необходимого для выполнения целей обработки,
              либо в соответствии с требованиями законодательства.
            </p>
          </Section>
          ...
          <Section title="7. Передача данных третьим лицам">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>когда это необходимо для работы сервисов сайта</li>
              <li>для бухгалтерского или технического обслуживания</li>
            </ul>
          </Section>
          ...
          <Section title="9. Безопасность данных">
            <p>
              ...
              для защиты персональных данных от утраты, изменения
